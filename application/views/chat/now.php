		...
		<script language="JavaScript">
			$(function() {
				...
				$.ajax({
					...
					success: function(data) {
					console.log(data);
					var scoreobj = jQuery.parseJSON(data);
						if (scoreobj.score) {
							$('#chatscore_label').html(scoreobj.score);
						}
					}
				});
				<?php
					...
					<div id="content_inner" class="well">
						...
						<div class="well" id="comm_window">
							...
							<div id="imgupload_div">
								<form>
								<input type="file" id="imgupload_file" name="imgupload"><a class="btn" onClick="ajaxFileUpload()">Upload</a><br/>
								</form>
							</div>
							</div>
							<script language="JavaScript">
