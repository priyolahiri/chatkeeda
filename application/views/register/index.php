...
<input type="radio" value="featured_columnists" name="writers">Columnists
            ...
            <div class="middle"> 
                <div class="widget"><h2 class="gentesque">Become a SportsKeeda Writer</h2><div class="line">&nbsp;</div>
                    <div class="textwidget">
                        <p><a href="http://www.sportskeeda.com/writing-for-sportskeeda/">Write for Sportskeeda</a></p> 
                        <p><a href="http://www.sportskeeda.com/why-to-write-for-sportskeeda/">SportsKeeda Advantage</a></p> 
                        <p><a href="http://www.sportskeeda.com/internship-program/">Internship Program</a></p>
                        <p><a href="http://www.sportskeeda.com/submit-your-blog-feed-2/">Submit your blog</a></p>
                        <p><a href="http://www.sportskeeda.com/writer-of-the-week/">Writer of the Week</a></p>
                    </div> 
                </div>                    
            </div> 
            <div class="right"> 
                <div class="widget"><h2 class="gentesque">Contact</h2><div class="line">&nbsp;</div>
                    <div class="textwidget">
                        <p>You can send us tips or ask any queries here contact @sportskeeda.com</p><p> 
                    </p></div> 
                </div>                        
                <br class="clearer">   
                <div class="widget">
        ...
        <div class="copyright"> 
            <div class="floatleft">
                <a href="http://www.sportskeeda.com/contact-us/" rel="nofollow" style="color: #888888;">Contact Us</a> |
                <a href="http://www.sportskeeda.com/careers/" rel="nofollow" style="color: #888888;">Careers</a> |
                <a href="http://www.sportskeeda.com/advertise/" rel="nofollow" style="color: #888888;">Advertise</a> |
                <a href="http://www.sportskeeda.com/keeda-team/" rel="nofollow" style="color: #888888;">Keeda Team</a> |
                <a href="http://www.sportskeeda.com/privacy-policy/" rel="nofollow" style="color: #888888;">Privacy Policy</a> | 
                <a href="http://www.sportskeeda.com/terms-of-use/" rel="nofollow" style="color: #888888;">Terms of Use</a> 
            </div>
            <div class="floatright">&copy;2010-2012 Absolute Sports Private Limited</div> 
            <br class="clearer"> 
        </div> 
    </div> 
    <div class="bottom">&nbsp;</div> 
            <script type="text/javascript">var _gaq=_gaq||[];_gaq.push(['_setAccount','UA-10769778-1']);_gaq.push(['_setDomainName','sportskeeda.com']);_gaq.push(['_trackPageview']);(function(){var ga=document.createElement('script');ga.type='text/javascript';ga.async=true;ga.src=('https:'==document.location.protocol?'https://ssl':'http://www')+'.google-analytics.com/ga.js';var s=document.getElementsByTagName('script')[0];s.parentNode.insertBefore(ga,s);})();</script>
        ...
        <!-- Begin comScore Tag -->
        <script>var _comscore=_comscore||[];_comscore.push({c1:"2",c2:"13438550"});(function(){var s=document.createElement("script"),el=document.getElementsByTagName("script")[0];s.async=true;s.src=(document.location.protocol=="https:"?"https://sb":"http://b")+".scorecardresearch.com/beacon.js";el.parentNode.insertBefore(s,el);})();</script>
        <noscript>
        &lt;img src="http://b.scorecardresearch.com/p?c1=2&amp;c2=13438550&amp;cv=2.0&amp;cj=1"/&gt;
        </noscript>
        <!-- End comScore Tag -->        
            <script src="http://1-ps.googleusercontent.com/h/www.sportskeeda.com/wp-content/themes/custom/js/combine.js,,qv==20120210,Mjm.dQms6aarMr.js+plugins.min.js,,qv==20120210,Mjm.9rLCzth4nU.js+writer.js,,qv==20120405,Mjm.b6mYdjYqBa.js.pagespeed.jc.7yGSvXZ7lN.js"></script><script>eval(mod_pagespeed_wAvKBjv5uo);</script>
    <script>eval(mod_pagespeed_nf1Q9HDHnB);</script>
    <script>eval(mod_pagespeed_4J3oex4Sko);</script>
    <script type="text/javascript">browser_width=parseInt($(window).width());if(browser_width&lt;1300)
{$('.navbutton').css('display','none');}</script>                
        <script src="http://1-ps.googleusercontent.com/h/www.sportskeeda.com/wp-content/themes/custom/js/supertip.js,Mjm.0-naneCHvE.js%20custom.js,Mjm.u4y4ZTip4S.js%20jquery.cookie.js,Mjm.9aa02FjDVk.js%20jquery.imagetick.js,Mjm.pt6dbNPr_c.js%20jquery.prettyPhoto.js,Mjm.x08N-vrgAx.js.pagespeed.jc.Fioj7BM82M.js"></script><script>eval(mod_pagespeed_Y6jjkL0r2j);</script> <!-- superfish menu dropdowns -->
    <script>eval(mod_pagespeed_aVkcm2JOMu);</script>
    <script>eval(mod_pagespeed_ZrVBQmfKqb);</script>
    <script>eval(mod_pagespeed_3q4Qh0MKJB);</script>
    <script>eval(mod_pagespeed_mAWtiRb4G0);</script>
    <script charset="utf-8" type="text/javascript">$(document).ready(function(){$("a[rel^='prettyPhoto']").prettyPhoto();});</script>
    <script type="text/javascript">$(window).load(function(){if(navigator.userAgent.match(/Chrome\/\d+/)){var chromeplugin=getCookie("sportkeedacp");if(chromeplugin!=1){$('div#chromeplugin').slideDown('fast');}}});function nothanks(){setCookie("sportkeedacp",1,1000);$('div#chromeplugin').slideUp('fast');}
function setCookie(name,value,expires)
{var today=new Date();today.setTime(today.getTime());if(expires){expires=expires*1000*60*60*24;}
var expires_date=new Date(today.getTime()+(expires));document.cookie=name+'='+escape(value)+((expires)?';expires='+expires_date.toUTCString():'');}
function getCookie(name)
{var start=document.cookie.indexOf(name+"=");var length=start+name.length+1;if((!start)&amp;&amp;(name!=document.cookie.substring(0,name.length))){return null;}
if(start==-1)return null;var end=document.cookie.indexOf(';',length);if(end==-1)end=document.cookie.length;return unescape(document.cookie.substring(length,end));}</script>    

    <script type="text/javascript">$(function()
{$('.galleryImage').hover(function()
{$(this).find('img').animate({width:80,height:50,marginTop:10,marginLeft:10},500);},function()
{$(this).find('img').animate({width:260,height:152,marginTop:0,marginLeft:0},300);});});</script> 
    
<!-- WP-FB AutoConnect Init v2.3.0 (NEW API) -->
    <div id="fb-root"></div>
    <script type="text/javascript">window.fbAsyncInit=function()
{FB.init({appId:'305340076146905',status:true,cookie:true,xfbml:true,oauth:true,channelUrl:'http://www.sportskeeda.com/wp-content/plugins/wp-fb-autoconnect/facebook-platform/channel.html'});};(function(){var e=document.createElement('script');e.src=document.location.protocol+'//connect.facebook.net/en_US/all.js';e.async=true;document.getElementById('fb-root').appendChild(e);}());</script>
    
<!-- WP-FB AutoConnect Callback v2.3.0 -->

    <form action="http://www.sportskeeda.com/wp-content/plugins/wp-fb-autoconnect/_process_login.php" method="post" name="jfb_js_login_callback_form" id="wp-fb-ac-fm">
        <input type="hidden" value="/" name="redirectTo">
            <input type="hidden" value="1e377c5424" name="autoconnect_nonce" id="autoconnect_nonce"><input type="hidden" value="/" name="_wp_http_referer">    </form>
    <script type="text/javascript">function jfb_js_login_callback()
{FB.getLoginStatus(function(response)
{if(!response.authResponse)
{return;}
document.jfb_js_login_callback_form.submit();});}</script>
    <script src="http://1-ps.googleusercontent.com/h/www.sportskeeda.com/wp-includes/js/admin-bar.js,qver=20111130.pagespeed.ce.AORFjdEWj2.js" type="text/javascript"></script>
<script src="http://1-ps.googleusercontent.com/x/www.sportskeeda.com/ajax.googleapis.com/ajax/libs/jqueryui/1.8.16/jquery-ui.min.js,qver%3D3.3.1.pagespeed.jm.kEVhjI15d7.js" type="text/javascript"></script>
<style type="text/css">.postbox-container .meta-box-sortables.empty-container,#side-sortables.empty-container{border:0}</style><script type="text/javascript">jQuery(document).ready(function(){jQuery("#wp-admin-bar-root-default").prepend(" &lt;li id=\"wlcms_admin_logo\"&gt; &lt;span style=\"float:left;height:28px;line-height:28px;vertical-align:middle;text-align:center;width:28px\"&gt;&lt;img src=\"http://liveuploads.s3.amazonaws.com/wp-content/uploads/2012/01/favicon2.ico\" width=\"16\" height=\"16\" alt=\"Login\" style=\"height:16px;width:16px;vertical-align:middle\" /&gt; &lt;/span&gt; &lt;/li&gt; ");});</script> <style type="text/css"></style>		<div role="navigation" class=" " id="wpadminbar"><div class="loginform">
				<form id="adminbarlogin" method="post" action="http://www.sportskeeda.com/wp-login.php">
					<input type="text" value="Username" id="adminbarlogin-log" name="log" class="adminbar-input">
					<input type="password" value="Password" id="adminbarlogin-pwd" name="pwd" class="adminbar-input">
                                        <input type="hidden" value="http://www.sportskeeda.com/" name="redirect_to">
					<input type="submit" value="Login" class="adminbar-button" style="opacity: 1;">
					<span class="adminbar-loginmeta">
						<input type="checkbox" name="rememberme" id="rememberme" value="forever" tabindex="3" checked="checked">
						<label for="rememberme">Remember me</label>
						<a href="http://www.sportskeeda.com/wp-login.php?action=lostpassword">Lost your password?</a>&nbsp;&nbsp;Register/Login with Facebook </span></form>
			<div class="quicklinks">
				<ul class="ab-top-secondary ab-top-menu" id="wp-admin-bar-top-secondary">
		<li class=" admin-bar-search" id="wp-admin-bar-search"><div tabindex="-1" class="ab-item ab-empty-item"><form id="adminbarsearch" method="get" action="http://www.sportskeeda.com/"><input type="text" maxlength="150" value="" tabindex="10" id="adminbar-search" name="s" class="adminbar-input" autocomplete="off"><input type="submit" value="Search" class="adminbar-button"><div id="wpabi_ajax"><span id="wpabi_close">close</span><div id="wpabi_results"></div></div></form></div>		</li></ul>			</div>
		</div>

		<!-- WP-FB AutoConnect Button v2.3.0 -->
    <span class="fbLoginButton">
        <script type="text/javascript">document.write('&lt;fb:login-button scope="email" v="2" size="small" onlogin="jfb_js_login_callback();" /&gt;');</script><fb:login-button onlogin="jfb_js_login_callback();" size="small" v="2" scope="email"><a class="fb_button fb_button_small"><span class="fb_button_text">Log In</span></a></fb:login-button></span>
